...
import org.junit.jupiter.api.Test;
 ...
 class PaymentOrderResponseTest {
    ...
    private PaymentOrderResponse.Account validAccount() {
        return PaymentOrderResponse.Account.builder()
    ...
    void testBuilderAndGetters() {
        ...
        assertEquals(new BigDecimal("150.50"), response.getInstructedAmount().getAmount());
    ...
    void testEqualsAndHashcode() {
        PaymentOrderResponse.Account account = PaymentOrderResponse.Account.builder()
                .iban("EC000")
                .build();

        PaymentOrderResponse.Amount amount = PaymentOrderResponse.Amount.builder()
